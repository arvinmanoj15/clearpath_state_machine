...
invoke_camera_and_navigation() {
    # This command will either run and terminate or will run for 70 seconds(Time for Ridgeback to turn around) and terminate
    timeout 70s rosrun vision ridgeback_vision &
